...
const MUSL_REWRITES: &[LibcRewrite] = &[
    ...
    LibcRewrite {
        implementation: "__pthread_cond_timedwait",
        public: "pthread_cond_timedwait",
        real: "__rsched_real_pthread_cond_timedwait",
        rsched: "rsched_pthread_cond_timedwait",
        diverges: false,
    },
    LibcRewrite {
    ...
    LibcRewrite {
        ...
        public: "sem_init",
        real: "__rsched_real_sem_init",
        rsched: "rsched_sem_init",
        diverges: false,
    },
    LibcRewrite {
        implementation: "sem_destroy",
        public: "sem_destroy",
        real: "__rsched_real_sem_destroy",
        rsched: "rsched_sem_destroy",
        diverges: false,
    },
    LibcRewrite {
        implementation: "sem_wait",
        public: "sem_wait",
        real: "__rsched_real_sem_wait",
        rsched: "rsched_sem_wait",
        diverges: false,
    },
    LibcRewrite {
        implementation: "sem_timedwait",
        public: "sem_timedwait",
        real: "__rsched_real_sem_timedwait",
        rsched: "rsched_sem_timedwait",
        diverges: false,
    },
    LibcRewrite {
    ...
    LibcRewrite {
        ...
        rsched: "rsched_sem_trywait",
        diverges: false,
    },
    LibcRewrite {
        implementation: "sem_post",
        public: "sem_post",
        real: "__rsched_real_sem_post",
        rsched: "rsched_sem_post",
        diverges: false,
    },
    LibcRewrite {
        implementation: "sem_getvalue",
        public: "sem_getvalue",
        real: "__rsched_real_sem_getvalue",
        rsched: "rsched_sem_getvalue",
        diverges: false,
    },
    LibcRewrite {
        implementation: "__pthread_detach",
        public: "pthread_detach",
        real: "__rsched_real_pthread_detach",
        rsched: "rsched_pthread_detach",
        diverges: false,
    },
    LibcRewrite {
        implementation: "pthread_cancel",
        public: "pthread_cancel",
        real: "__rsched_real_pthread_cancel",
        rsched: "rsched_pthread_cancel",
        diverges: false,
    },
    LibcRewrite {
        implementation: "__pthread_once",
        public: "pthread_once",
        real: "__rsched_real_pthread_once",
        rsched: "rsched_pthread_once",
        diverges: false,
    },
    LibcRewrite {
        implementation: "pthread_rwlock_init",
        public: "pthread_rwlock_init",
        real: "__rsched_real_pthread_rwlock_init",
        rsched: "rsched_pthread_rwlock_init",
        diverges: false,
    },
    LibcRewrite {
        implementation: "pthread_rwlock_destroy",
        public: "pthread_rwlock_destroy",
        real: "__rsched_real_pthread_rwlock_destroy",
        rsched: "rsched_pthread_rwlock_destroy",
        diverges: false,
    },
    LibcRewrite {
        implementation: "__pthread_rwlock_rdlock",
        public: "pthread_rwlock_rdlock",
        real: "__rsched_real_pthread_rwlock_rdlock",
        rsched: "rsched_pthread_rwlock_rdlock",
        diverges: false,
    },
    LibcRewrite {
        implementation: "__pthread_rwlock_wrlock",
        public: "pthread_rwlock_wrlock",
        real: "__rsched_real_pthread_rwlock_wrlock",
        rsched: "rsched_pthread_rwlock_wrlock",
        diverges: false,
    },
    LibcRewrite {
        implementation: "__pthread_rwlock_tryrdlock",
        public: "pthread_rwlock_tryrdlock",
        real: "__rsched_real_pthread_rwlock_tryrdlock",
        rsched: "rsched_pthread_rwlock_tryrdlock",
        diverges: false,
    },
    LibcRewrite {
        implementation: "__pthread_rwlock_trywrlock",
        public: "pthread_rwlock_trywrlock",
        real: "__rsched_real_pthread_rwlock_trywrlock",
        rsched: "rsched_pthread_rwlock_trywrlock",
        diverges: false,
    },
    LibcRewrite {
        implementation: "__pthread_rwlock_timedrdlock",
        public: "pthread_rwlock_timedrdlock",
        real: "__rsched_real_pthread_rwlock_timedrdlock",
        rsched: "rsched_pthread_rwlock_timedrdlock",
        diverges: false,
    },
    LibcRewrite {
        implementation: "__pthread_rwlock_timedwrlock",
        public: "pthread_rwlock_timedwrlock",
        real: "__rsched_real_pthread_rwlock_timedwrlock",
        rsched: "rsched_pthread_rwlock_timedwrlock",
        diverges: false,
    },
    LibcRewrite {
        implementation: "__pthread_rwlock_unlock",
        public: "pthread_rwlock_unlock",
        real: "__rsched_real_pthread_rwlock_unlock",
        rsched: "rsched_pthread_rwlock_unlock",
        diverges: false,
    },
    LibcRewrite {
        implementation: "pthread_spin_init",
        public: "pthread_spin_init",
        real: "__rsched_real_pthread_spin_init",
        rsched: "rsched_pthread_spin_init",
        diverges: false,
    },
    LibcRewrite {
        implementation: "pthread_spin_destroy",
        public: "pthread_spin_destroy",
        real: "__rsched_real_pthread_spin_destroy",
        rsched: "rsched_pthread_spin_destroy",
        diverges: false,
    },
    LibcRewrite {
        implementation: "pthread_spin_lock",
        public: "pthread_spin_lock",
        real: "__rsched_real_pthread_spin_lock",
        rsched: "rsched_pthread_spin_lock",
        diverges: false,
    },
    LibcRewrite {
        implementation: "pthread_spin_trylock",
        public: "pthread_spin_trylock",
        real: "__rsched_real_pthread_spin_trylock",
        rsched: "rsched_pthread_spin_trylock",
        diverges: false,
    },
    LibcRewrite {
        implementation: "pthread_spin_unlock",
        public: "pthread_spin_unlock",
        real: "__rsched_real_pthread_spin_unlock",
        rsched: "rsched_pthread_spin_unlock",
        diverges: false,
    },
    LibcRewrite {
        implementation: "cnd_wait",
        public: "cnd_wait",
        real: "__rsched_real_cnd_wait",
        rsched: "rsched_cnd_wait",
        diverges: false,
    },
    LibcRewrite {
        implementation: "cnd_timedwait",
        public: "cnd_timedwait",
        real: "__rsched_real_cnd_timedwait",
        rsched: "rsched_cnd_timedwait",
        diverges: false,
    },
    LibcRewrite {
        implementation: "mtx_lock",
        public: "mtx_lock",
        real: "__rsched_real_mtx_lock",
        rsched: "rsched_mtx_lock",
        diverges: false,
    },
    LibcRewrite {
        implementation: "mtx_timedlock",
        public: "mtx_timedlock",
        real: "__rsched_real_mtx_timedlock",
        rsched: "rsched_mtx_timedlock",
        diverges: false,
    },
    LibcRewrite {
        implementation: "mtx_trylock",
        public: "mtx_trylock",
        real: "__rsched_real_mtx_trylock",
        rsched: "rsched_mtx_trylock",
        diverges: false,
    },
    LibcRewrite {
        implementation: "mtx_unlock",
        public: "mtx_unlock",
        real: "__rsched_real_mtx_unlock",
        rsched: "rsched_mtx_unlock",
        diverges: false,
    },
    LibcRewrite {
        implementation: "call_once",
        public: "call_once",
        real: "__rsched_real_call_once",
        rsched: "rsched_call_once",
        diverges: false,
    },
    LibcRewrite {
